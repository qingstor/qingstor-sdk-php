...
class Bucket
{
    ...
    /**
     * deleteMetadataRequest: Build DeleteMetadata's request
     * @link https://docs.qingcloud.com/qingstor/api/common/metadata Documentation URL
     *
     * @return Request
     */
    public function deleteMetadataRequest()
    {
        $operation = array(
            'API' => 'DeleteMetadata',
            'Method' => 'DELETE',
            'Uri' => '/<bucket-name>?metadata',
            'Headers' => array(
                'Host' => $this->properties['zone'] . '.' . $this->config->host,
            ),
            'Params' => array(
        ...
        $this->deleteMetadataValidate($operation);
        $req = new Request($this->config, $operation);
        return $req;
    }
    ...
    /**
     * deleteMetadata: Delete a Metadata.
     * @link https://docs.qingcloud.com/qingstor/api/common/metadata Documentation URL
     * @return Unpacker
     * @throws \Exception
     */
    ...
    {
        $req = $this->deleteMetadataRequest();
        $retries = $this->config->connection_retries;
        while(1){
            try {
                $GLOBALS['logger']->info('Sending QingStor request: deleteMetadata');
                $response = new Unpacker($this->config->client->send(
                    $req->sign()
                ));
            } catch (\Exception $e) {
    ...
    /**
     * deleteMetadataQuery: deleteMetadata's Query Sign Way
     * @link https://docs.qingcloud.com/qingstor/api/common/metadata Documentation URL
     *
     * @return Request
     */
    public function deleteMetadataQuery($expires)
        {
            $req = $this->deleteMetadataRequest();
            return $req->query_sign($expires);
        }
    
    public function deleteMetadataValidate($operation)
    {
    }

    
    /**
     * getMetadataRequest: Build GetMetadata's request
     * @link https://docs.qingcloud.com/qingstor/api/common/metadata Documentation URL
     *
     * @return Request
     */
    public function getMetadataRequest()
    {
        ...
        $this->getMetadataValidate($operation);
        $req = new Request($this->config, $operation);
        return $req;
    }
    ...
    {
        $req = $this->getMetadataRequest();
        $retries = $this->config->connection_retries;
        while(1){
            try {
                $GLOBALS['logger']->info('Sending QingStor request: getMetadata');
                $response = new Unpacker($this->config->client->send(
                    $req->sign()
                ));
            } catch (\Exception $e) {
    ...
    /**
     * getMetadataQuery: getMetadata's Query Sign Way
     * @link https://docs.qingcloud.com/qingstor/api/common/metadata Documentation URL
     *
     * @return Request
     */
    public function getMetadataQuery($expires)
        {
            $req = $this->getMetadataRequest();
            return $req->query_sign($expires);
        }
    
    public function getMetadataValidate($operation)
    {
    }

    
    /**
     * putMetadataRequest: Build PutMetadata's request
     * @link https://docs.qingcloud.com/qingstor/api/common/metadata Documentation URL
     *
     * @return Request
     */
    public function putMetadataRequest()
    {
        $operation = array(
            'API' => 'PutMetadata',
            'Method' => 'PUT',
        ...
        $this->putMetadataValidate($operation);
        $req = new Request($this->config, $operation);
        return $req;
    }
    ...
    /**
     * putMetadata: Create a new Metadata.
     * @link https://docs.qingcloud.com/qingstor/api/common/metadata Documentation URL
     * @return Unpacker
     * @throws \Exception
     */
    ...
    {
        $req = $this->putMetadataRequest();
        $retries = $this->config->connection_retries;
        while(1){
            try {
                $GLOBALS['logger']->info('Sending QingStor request: putMetadata');
                $response = new Unpacker($this->config->client->send(
                    $req->sign()
                ));
            } catch (\Exception $e) {
    ...
    /**
     * putMetadataQuery: putMetadata's Query Sign Way
     * @link https://docs.qingcloud.com/qingstor/api/common/metadata Documentation URL
     *
     * @return Request
     */
    public function putMetadataQuery($expires)
        {
            $req = $this->putMetadataRequest();
            return $req->query_sign($expires);
        }
    
    public function putMetadataValidate($operation)
    {
    }
